...
public class ParticleFilter {
    ...
    public void createProgram() {
        String vertexShader = mContext.getResources().getString(R.string.pv_particle_vertex);
        String fragmentShader = mContext.getResources().getString(R.string.pv_particle_fragment);
